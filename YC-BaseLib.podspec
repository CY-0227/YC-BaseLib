...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "chenyun" => "273962965@qq.com" }
  # Or just: spec.author    = "chenyun"
  # spec.authors            = { "chenyun" => "273962965@qq.com" }
  # spec.social_media_url   = "https://twitter.com/chenyun"
  ...
  spec.source       = { :git => "https://github.com/CY-0227/YC-BaseLib.git", :tag => spec.version }
  ...
  # spec.source_files  = "YC-BaseLib/*.{h,m}"
